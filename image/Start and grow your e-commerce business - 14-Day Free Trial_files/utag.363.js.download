//tealium universal tag - utag.363 ut4.0.202207201427, Copyright 2022 Tealium.com Inc. All Rights Reserved.
...
u.ev={"view":1,"link":1};u.map={"_ext_ispot_type:visit:act_type":"visit","_ext_ispot_type:lead:act_type":"lead","_ext_ispot_uid":"uid"};u.extend=[];u.send=function(a,b){if(u.ev[a]||u.ev.all!==undefined){utag.DB("send:363");utag.DB(b);var c,d,e,f,h,key,custom_data_pairs;u.data={"base_url":"//pt.ispot.tv/v2/##utag_site_id##.gif?","site_id":"TC-4228-1","app":"web","uid":"","cid":"","type":"","url":"","datetime":"","ip":"","os":"","device":"","language":"","custom":{}};utag.DB("send:363:EXTENSIONS");utag.DB(b);c=[];for(d in utag.loader.GV(u.map)){if(b[d]!==undefined&&b[d]!==""){e=u.map[d].split(",");for(f=0;f<e.length;f++){if(u.data.hasOwnProperty(e[f])){u.data[e[f]]=b[d];}else{u.data.custom[e[f]]=b[d];}}}else{h=d.split(":");if(h.length===3&&b[h[0]]===h[1]){if(u.map[d]){u.data.type=u.map[d];}}}}
utag.DB("send:363:MAPPINGS");utag.DB(u.data);u.data.uid=u.data.uid||b._ccustid||"";if(u.data.uid){c.push("uid="+u.data.uid);}
...
u.data.base_url=u.data.base_url.replace("##utag_site_id##",u.data.site_id);u.loader({"type":"img","src":u.data.base_url+c.join("&")});utag.DB("send:363:COMPLETE");}};utag.o[loader].loader.LOAD(id);}("363","shopify.main"));}catch(error){utag.DB(error);}
